            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>published at here</td>
                        <td>
                            <a href="showone?id=<?php echo $post->_id?>" class="btn btn-sm btn-primary">Show</a>
                            <a href="edit-post.php?id=<?php echo $post->_id?>" class="btn btn-sm btn-secondary">Edit</a>
                            <a href="handle/delete-post.php?id=<?php echo $post->_id?>" class="btn btn-sm btn-danger" onclick="return confirm('do you really want to delete post?')">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach ?>
